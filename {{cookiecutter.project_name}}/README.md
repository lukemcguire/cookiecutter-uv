...
**Note:** Prek hooks run automatically on `git commit` and may modify files to fix formatting. If this happens, just add the changes again and recommit.
...
For more details, see [here](https://lukemcguire.github.io/cookiecutter-uv/features/cicd/#how-to-trigger-a-release).
{%- endif %}
