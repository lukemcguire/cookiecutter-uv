...
[ruff](https://github.com/charliermarsh/ruff) is used to lint and format the code, and it is configured through `pyproject.toml` with comprehensive rules covering security, style, best practices, and documentation:
